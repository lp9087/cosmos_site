# Generated by Django 3.2.9 on 2022-03-25 11:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('polymorphic_ctype', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='polymorphic_main.menuitems_set+', to='contenttypes.contenttype')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.FileField(blank=True, upload_to='services_images/', validators=[django.core.validators.FileExtensionValidator(['jpg', 'png', 'jpeg', 'svg'])], verbose_name='Изображение')),
                ('slug', models.SlugField(unique=True, verbose_name='URL')),
            ],
            options={
                'verbose_name': 'услуга',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('map', models.BooleanField(default=False, verbose_name='Отображение карты проектов')),
                ('slug', models.SlugField(unique=True, verbose_name='URL')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='NewsMenuItems',
            fields=[
                ('menuitems_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='main.menuitems')),
            ],
            options={
                'verbose_name': 'новость',
                'verbose_name_plural': 'новости',
            },
            bases=('main.menuitems',),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vacancy', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='vacancy', to='main.vacancy', verbose_name='Ваканисия')),
            ],
            options={
                'verbose_name': 'резюме',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('position', models.PositiveSmallIntegerField(null=True, verbose_name='Позиция')),
                ('description', models.TextField(blank=True, default='', verbose_name='Описание')),
                ('link', models.URLField(blank=True, default='', verbose_name='Ссылка на сайт')),
        ...
        migrations.CreateModel(
            name='CustomPageMenuItems',
            fields=[
                ('menuitems_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='main.menuitems')),
                ('custom_page', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.custompages', verbose_name='Страница')),
            ],
            options={
                'verbose_name': 'кастомная страница',
                'verbose_name_plural': 'кастомные страницы',
